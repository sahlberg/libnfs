...
struct rpc_pdu *rpc_nfsacl_null_async(struct rpc_context *rpc, rpc_cb cb,
				      void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_nfsacl_getacl_async(struct rpc_context *rpc, rpc_cb cb,
...
struct rpc_pdu *rpc_nfsacl_setacl_async(struct rpc_context *rpc, rpc_cb cb,
