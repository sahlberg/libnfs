...
struct rpc_pdu *rpc_nlm4_null_async(struct rpc_context *rpc, rpc_cb cb,
				    void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_nlm4_test_async(struct rpc_context *rpc, rpc_cb cb,
...
struct rpc_pdu *rpc_nlm4_lock_async(struct rpc_context *rpc, rpc_cb cb,
...
struct rpc_pdu *rpc_nlm4_cancel_async(struct rpc_context *rpc, rpc_cb cb,
...
struct rpc_pdu *rpc_nlm4_unlock_async(struct rpc_context *rpc, rpc_cb cb,
...
struct rpc_pdu *rpc_nlm4_share_async(struct rpc_context *rpc, rpc_cb cb,
...
struct rpc_pdu *rpc_nlm4_unshare_async(struct rpc_context *rpc, rpc_cb cb,
				       struct NLM4_SHAREargs *args,
				       void *private_data)
{
	struct rpc_pdu *pdu;
