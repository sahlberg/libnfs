 ...
 * PORTMAP v2
 */
struct rpc_pdu *rpc_pmap2_null_async(struct rpc_context *rpc,
...
struct rpc_pdu *rpc_pmap2_getport_async(struct rpc_context *rpc, int program,
					int version, int protocol, rpc_cb cb,
					void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap2_set_async(struct rpc_context *rpc, int program,
...
struct rpc_pdu *rpc_pmap2_unset_async(struct rpc_context *rpc, int program,
				      int version, int protocol, int port,
				      rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap2_dump_async(struct rpc_context *rpc,
				     rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap2_callit_async(struct rpc_context *rpc, int program,
				       int version, int procedure, char *data,
				       int datalen,
				       rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
 ...
 * PORTMAP v3
 */
struct rpc_pdu *rpc_pmap3_null_async(struct rpc_context *rpc,
				     rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap3_set_async(struct rpc_context *rpc,
...
struct rpc_pdu *
rpc_pmap3_unset_async(struct rpc_context *rpc, struct pmap3_mapping *map,
		      rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap3_getaddr_async(struct rpc_context *rpc,
					struct pmap3_mapping *map,
					rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap3_dump_async(struct rpc_context *rpc,
				     rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap3_gettime_async(struct rpc_context *rpc,
					rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap3_callit_async(struct rpc_context *rpc, int program,
				       int version, int procedure, char *data,
				       int datalen,
				       rpc_cb cb, void *private_data)
{
...
struct rpc_pdu *rpc_pmap3_uaddr2taddr_async(struct rpc_context *rpc,
					    char *uaddr,
					    rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
...
struct rpc_pdu *rpc_pmap3_taddr2uaddr_async(struct rpc_context *rpc,
					    struct pmap3_netbuf *nb,
					    rpc_cb cb, void *private_data)
{
	struct rpc_pdu *pdu;
